...
#########################
current_user = CurrentUser(first_name='Arman', last_name='Popli', email='armanpopli2023@u.northwestern.edu', username='apopli01')
...
@app.route('/')
def exercise1():
    return 'We were born into a world that was meant to burn!'
